...
package top.doitcore.admin.generator.model.entity;
...
public class GenConfigDO implements Serializable {
     ...
     * 模块名称
     */
    @Schema(description = "模块名称", example = "doitcore-admin-system")
     ...
     * 包名称
     */
    @Schema(description = "包名称", example = "top.doitcore.admin.system")
